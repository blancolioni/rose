            ...
            case Action is
               ...
               when Write =>
                  if Mem.Virtual_Map.Writable (Mapping) then
                     ...
                     Rose.Console_IO.Put ("mem: ");
                     Rose.Console_IO.Put (Natural (Process_Id));
                     Rose.Console_IO.Put (": page dirty: ");
                     Rose.Console_IO.Put (Rose.Words.Word_32 (Virtual_Page));
                     Rose.Console_IO.Put ("/");
                     Rose.Console_IO.Put (Rose.Words.Word_32 (Physical_Page));
                     Rose.Console_IO.New_Line;

                     Mem.Virtual_Map.Set_Read_Write (Mapping);
                     Mem.Processes.Set_Dirty
                       (Object, Virtual_Page, Physical_Page);
                     Mem.Processes.Resume_Process (Process_Id);
                  end if;
            end case;
         end;
